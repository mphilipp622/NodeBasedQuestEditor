...
/// <summary>
/// This class handles inputs into the node. Inputs are typically drawn on the left side of the node and can 
/// have outputs dragged and dropped onto them.
/// </summary>
public class NodeInput : ScriptableObject
{
	/// <summary> The node that the input is coming from. </summary>
	public Node body;
